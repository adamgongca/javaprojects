...
public class ModuleParameter extends BaseFormsObject
{
    ...
    public ModuleParameter(FormModule formmodule, String s)
    {
        super(0L);
    ...
    public ModuleParameter(FormModule formmodule, String s, ModuleParameter moduleparameter)
    {
        super(0L);
        super.m_pd2fob = BaseAPI._jni_create_object(Jdapi.getContextPointer(), formmodule.getObjectPointer(), s_foType, s, 0L, moduleparameter.getObjectPointer());
        Jdapi.addObject(this);
    }

    public ModuleParameter(FormModule formmodule, String s, PropertyClass propertyclass)
    {
        super(0L);
    ...
    public ModuleParameter(ObjectLibrary objectlibrary, ObjectLibraryTab objectlibrarytab, String s)
    {
        super(0L);
    ...
    public ModuleParameter(ObjectLibrary objectlibrary, ObjectLibraryTab objectlibrarytab, String s, ModuleParameter moduleparameter)
    {
        super(0L);
        super.m_pd2fob = BaseAPI._jni_create_object(Jdapi.getContextPointer(), objectlibrarytab.getObjectPointer(), s_foType, s, objectlibrary.getObjectPointer(), moduleparameter.getObjectPointer());
        Jdapi.addObject(this);
    }

    public ModuleParameter(ObjectLibrary objectlibrary, ObjectLibraryTab objectlibrarytab, String s, PropertyClass propertyclass)
    {
        super(0L);
    ...
    protected ModuleParameter(long l)
    {
        super(l);
    }

    public ModuleParameter clone(FormModule formmodule, String s)
    {
        return (ModuleParameter)super.clone(formmodule, s);
    }

    public ModuleParameter clone(ObjectLibraryTab objectlibrarytab, String s)
    {
        return (ModuleParameter)super.clone(objectlibrarytab, s);
    }

    public static ModuleParameter find(FormModule formmodule, String s)
    {
        ...
        if(l1 != 0L)
            moduleparameter = (ModuleParameter)Jdapi.getObject(l1);
        return moduleparameter;
    }

    public static ModuleParameter find(ObjectLibraryTab objectlibrarytab, String s)
    {
        long l = Jdapi.getContextPointer();
    ...
    {
        return getStringProperty(JdapiTypes.PARAMETER_INITIALIZE_VALUE_PTID);
    }

    public void setParameterInitializeValue(String s)
    {
        setStringProperty(JdapiTypes.PARAMETER_INITIALIZE_VALUE_PTID, s);
    }
    ...
    {
        return getIntegerProperty(JdapiTypes.PARAMETER_DATA_TYPE_PTID);
    }

    public void setParameterDataType(int i)
    {
        setIntegerProperty(JdapiTypes.PARAMETER_DATA_TYPE_PTID, i);
    }
    ...
    static 
    {
        s_foType = JdapiTypes.FORM_PARAMETER_OTID;
    }
}
